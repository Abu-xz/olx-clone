            ...
            <div className="p-3 flex justify-center">
                <div className="w-full max-w-7xl bg-cyan-50 p-5 rounded-md">
                    <div className="flex items-center justify-between mb-4">
                        <h1 className="text-xl font-semibold ml-5">More on For Rent: Houses & Apartments</h1>
                        <button className="underline font-bold hover:no-underline mr-5">View more</button>
                    </div>
